...
HD_PWD='C:/Users/victo/OneDrive/Documentos/5 ao/TOC/project_2NuevoIntento/project_2NuevoIntento.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopCerrojo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopCerrojo.tcl
