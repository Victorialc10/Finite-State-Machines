...
HD_PWD='C:/Users/victo/OneDrive/Documentos/5 ao/TOC/project_2NuevoIntento/project_2NuevoIntento.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopCerrojo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopCerrojo.tcl -notrace
